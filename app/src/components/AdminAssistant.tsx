                        ...
                        contents: [
                            {
                                parts: [
                                    {
                                        text: `أنت مساعد ذكي لإدارة صالة رياضية (Healy Academy). تساعد المدير في الإجابة على أسئلته عن الطلاب، الإيرادات، والإحصائيات. تجاوب بالعربي بطريقة واضحة ومفيدة.\n\nالسؤال: ${input}`
                                    }
                                ]
                            }
                        ]
